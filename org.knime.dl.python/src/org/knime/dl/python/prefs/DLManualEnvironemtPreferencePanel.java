 ...
 */
public class DLManualEnvironemtPreferencePanel extends AbstractPythonConfigPanel<DLManualEnvironmentConfig, Composite> {

    public DLManualEnvironemtPreferencePanel(final DLManualEnvironmentConfig config, final Composite parent) {
        super(config, parent);
